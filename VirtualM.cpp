...
int main_() {
    ...
    //s1->DisplayDetails()-> detalii pt rectangle
    //acelasi lucru pt calculul ariei si afisarea acesteia

    Shape* s1, * s2;
    s1 = new Circle("CERC", 10);
    s1->DisplayDetails();
    cout << "ARIA CERC: " << s1->CalculateArea() << endl;

    s2 = new Rectangle("RECTANGLE", 10, 5);
    s2->DisplayDetails();
    cout << "ARIA RECTANGLE: " << s2->CalculateArea() << endl;
